            ...
            <div class="space-y-6 p-6">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <p class="mt-1.5 text-xs leading-5 text-slate-500">
                        Tenant selection is optional for tenant admins. Assign a tenant only if you want this admin linked to a specific tenant context.
                    </p>
                ...
                >
                    This account will have full system-wide access. Tenant selection is optional and can be used as the user's default tenant context.
                </div>
                ...
                >
                    Tenant admins must be assigned to a tenant because they manage tenant-specific users, websites, leads, and conversations.
                </div>
                ...
                >
                    Agents must be assigned to a tenant. They will only access conversations and websites within that tenant.
                </div>
                    <div x-show="role === 'super_admin'" x-cloak class="rounded-xl border border-violet-200 bg-violet-50 p-4 text-sm text-violet-800">
                        This account will have full system-wide access.
                    </div>
                </div>
                <div>
